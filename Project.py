...
Bedrooms  = st.number_input("Enter the number of Bedrooms",min_value=2,max_value=4,step=1)
...
if st.button("Submit"):
  ...
  st.write(f"The price for the flat with given details is RS.{prediction[0]:,.2f}")
